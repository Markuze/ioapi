...
#define DMA_CACHE_SHIFT		16	/* 64K */

#define HUGE_PAGE_ELEM_SHIFT	(21) /* 2MB huge pages */
#define HUGE_PAGE_ELEM_SIZE	(BIT(HUGE_PAGE_ELEM_SHIFT))
#define HUGE_PAGE_ELEM_MASK	(HUGE_PAGE_ELEM_SIZE - 1)
#define ELEM_CNT_IN_HUGE	(BIT(HUGE_PAGE_ELEM_SHIFT - DMA_CACHE_SHIFT))
